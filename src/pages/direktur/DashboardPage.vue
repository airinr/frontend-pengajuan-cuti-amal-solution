...
const fetchData = async () => {
  ...
  error.value = null;
  try {
    const [statsRes, mendatangRes, userRes] = await Promise.allSettled([
...
<template>
  <div class="space-y-4 lg:space-y-6">
    <div>
      <h1 class="text-xl lg:text-2xl font-bold text-gray-800">{{ t('dashboard.title') || 'Dashboard Direktur' }}</h1>
