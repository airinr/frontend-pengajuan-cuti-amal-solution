...
const handleChangePassword = async () => {
  ...
  try {
    ...
    passwordSuccess.value = t('error.passwordChanged')
    passwordForm.value = { password_lama: '', password_baru: '', konfirmasi_password_baru: '' }
    showPasswordForm.value = false
  } catch (err: any) {
    passwordError.value = err.response?.data?.detail || t('error.passwordChangeFailed')
  } finally {
...
const handleSaveProfile = async () => {
  ...
  try {
    ...
    errorMessage.value = err.response?.data?.detail || t('error.profileSaveFailed')
  } finally {
...
<template>
  <div>
    <h1 class="text-xl lg:text-2xl font-bold text-gray-800 mb-4 lg:mb-6">{{ t('profile.title') }}</h1>
        ...
        <div class="flex-1 space-y-4 lg:space-y-6">
          ...
          <div class="bg-gradient-to-br from-blue-50 to-white rounded-xl shadow-sm border border-blue-100 p-4 lg:p-6">
            <div class="flex items-center gap-2 mb-4 lg:mb-6">
              ...
              <h3 class="font-semibold text-gray-800">{{ t('profile.accountInfo') }}</h3>
            </div>
          ...
          <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:p-6">
            <div class="flex items-center gap-2 mb-4 lg:mb-6">
              ...
              <h3 class="font-semibold text-gray-800">{{ t('profile.security') }}</h3>
            </div>
            ...
            <div class="space-y-4">
              ...
              >
                ...
                <div>
                  <p class="text-sm font-medium text-gray-800">{{ t('profile.changePassword') }}</p>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  <p class="text-sm font-medium text-gray-800">{{ t('profile.language') }}</p>
        ...
        >
          <div class="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6">
            <div class="flex items-center justify-between mb-4">
              <h3 class="text-lg font-bold text-gray-800">{{ t('profile.language') }}</h3>
              <button @click="showLanguageModal = false" class="p-1 text-gray-400 hover:text-gray-600 cursor-pointer">
            ...
            <div class="space-y-2">
              <button
                ...
                :class="[
                  ...
                  locale === 'id' ? 'bg-blue-50 border-2 border-blue-500' : 'border-2 border-gray-200 hover:bg-gray-50'
                ]"
              >
                ...
                <svg v-if="locale === 'id'" class="w-5 h-5 text-blue-600 ml-auto" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                :class="[
                  'w-full flex items-center gap-3 p-3 rounded-lg transition-colors text-left',
                  locale === 'en' ? 'bg-blue-50 border-2 border-blue-500' : 'border-2 border-gray-200 hover:bg-gray-50'
                ]"
              >
                <span class="text-2xl">🇬🇧</span>
                <div>
                ...
                <svg v-if="locale === 'en'" class="w-5 h-5 text-blue-600 ml-auto" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z" />
                </svg>
              </button>
            </div>
