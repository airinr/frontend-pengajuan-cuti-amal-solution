...
<template>
  <div class="space-y-6">
    <div class="flex justify-between items-center">
      <div>
        <h1 class="text-2xl font-bold text-gray-800">Ringkasan Cuti</h1>
        <p class="text-sm text-gray-500">Periode Tahun 2024</p>
      </div>
      <button
        @click="goToPengajuan"
        class="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors cursor-pointer"
      >
        + Buat Pengajuan
      </button>
    </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-2xl font-bold text-gray-800">{{ totalCuti }} <span class="text-sm font-normal text-gray-500">Hari</span></p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-2xl font-bold text-gray-800">{{ terpakai }} <span class="text-sm font-normal text-gray-500">Hari</span></p>
            </div>
          </div>
        </div>

        <div class="bg-gray-600 rounded-xl p-6 shadow-sm text-white">
          ...
          <div class="flex items-center gap-6">
            <div class="relative w-20 h-20">
              ...
              <div class="absolute inset-0 flex items-center justify-center">
                <span class="text-xl font-bold">{{ sisaCuti }}</span>
              </div>
            </div>
            <div>
              <p class="text-3xl font-bold">{{ sisaCuti }} <span class="text-base font-normal text-gray-200">Hari</span></p>
      ...
      <div class="grid grid-cols-3 gap-6">
        <div class="col-span-2 space-y-6">
          <div class="bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="p-6 text-center text-gray-400 text-sm">-</div>
          </div>
