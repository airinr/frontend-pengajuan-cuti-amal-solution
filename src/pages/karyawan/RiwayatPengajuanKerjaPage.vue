...
const totalPages = computed(() =>
  Math.ceil(filteredRiwayat.value.length / itemsPerPage),
);
  ...
  <div>
    ...
    <div v-else class="bg-white rounded-xl shadow-sm border border-gray-100">
      ...
      <div class="p-4 border-b border-gray-100">
        ...
        >
          <div
            class="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-lg border border-gray-200 w-full sm:w-auto"
          >
            <svg
            ...
            <select
              ...
              class="bg-transparent text-sm font-medium text-gray-700 outline-none cursor-pointer"
            >
      ...
      <div class="hidden md:block overflow-x-auto">
        <table class="w-full">
          <thead>
            <tr
              class="text-left text-xs font-semibold text-gray-500 uppercase tracking-wider border-b border-gray-100"
            >
      ...
      <div class="md:hidden divide-y divide-gray-100">
        <div
          v-if="paginatedRiwayat.length === 0"
