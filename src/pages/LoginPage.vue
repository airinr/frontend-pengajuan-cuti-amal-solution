    ...
    <div class="w-full max-w-md">
      <div class="bg-white rounded-3xl shadow-lg p-8">
        ...
        <form @submit="handleSubmit" class="space-y-4">
          ...
          <div>
            <div class="flex justify-between items-center mb-1.5">
              ...
              <button type="button" class="text-sm text-blue-600 hover:text-blue-700 cursor-pointer">
                Lupa kata sandi?
              </button>
            </div>
            <div class="relative">
        ...
        <p class="mt-6 text-center text-sm text-gray-500">
          Belum punya akun?
          <button @click="emit('switchToRegister')" class="text-blue-600 hover:text-blue-700 font-medium cursor-pointer">
            Daftar di sini
          </button>
        </p>
      </div>
