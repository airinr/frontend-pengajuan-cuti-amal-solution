  ...
  <div class="min-h-screen bg-gray-50 flex items-center justify-center p-4">
    <div class="w-full max-w-md">
      <div class="text-center mb-8">
        ...
        <p class="text-gray-500 mt-1">Bergabung dengan sistem manajemen cuti kami.</p>
      </div>

      <div class="bg-white rounded-3xl shadow-lg p-8">
        <div v-if="error" class="mb-4 p-3 bg-red-50 border border-red-200 rounded-xl text-red-600 text-sm text-center">
          {{ error }}
        </div>
        ...
        <form @submit="handleSubmit" class="space-y-4">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1.5">Pilih Departemen</label>
            <div class="relative">
              <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                ...
                <option v-for="dept in departments" :key="dept.id_departemen" :value="dept.id_departemen">
          ...
          <label class="flex items-start gap-3 cursor-pointer pt-2">
            ...
            <span class="text-sm text-gray-500">
              Saya setuju dengan
              <button type="button" class="text-blue-600 hover:text-blue-700 font-medium cursor-pointer">Syarat</button>
              dan
              <button type="button" class="text-blue-600 hover:text-blue-700 font-medium cursor-pointer">Ketentuan</button>
              yang berlaku.
            </span>
          </label>
      ...
      <p class="mt-6 text-center text-sm text-gray-500">
        Sudah punya akun?
        <button @click="emit('switchToLogin')" class="text-blue-600 hover:text-blue-700 font-medium cursor-pointer">
          Masuk di sini
        </button>
      </p>
    </div>
